INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 1, 101, 'Sendero del Sol', 'Montaña', '2025-06-10', '07:00', 'Cundinamarca', 'La Calera', 180);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 2, 102, 'Aventura del Río', 'Río', '2025-07-15', '08:30', 'Antioquia', 'Guatapé', 120);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 3, 103, 'Exploración del Bosque', 'Bosque', '2025-08-20', '06:45', 'Meta', 'Villavicencio', 150);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 4, 104, 'Ruta del Nevado', 'Nevado', '2025-09-05', '05:30', 'Tolima', 'Murillo', 240);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 5, 105, 'Caminata Nocturna', 'Nocturna', '2025-10-01', '19:00', 'Boyacá', 'Villa de Leyva', 90);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 6, 106, 'Sendero del Viento', 'Montaña', '2025-10-15', '07:15', 'Cundinamarca', 'Sibaté', 180);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 7, 107, 'Cima de los Andes', 'Montaña', '2025-11-01', '06:00', 'Cundinamarca', 'La Calera', 210);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 8, 108, 'Exploración Subterránea', 'Cueva', '2025-11-20', '09:30', 'Santander', 'Barichara', 120);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 9, 109, 'Aventura del Volcán', 'Volcán', '2025-12-10', '08:00', 'Cauca', 'Popayán', 180);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 10, 110, 'Caminata del Lago', 'Lago', '2025-12-15', '07:45', 'Nariño', 'San Juan de Pasto', 150);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 11, 111, 'Aventura de los Parques', 'Parque', '2026-01-05', '10:00', 'Cundinamarca', 'Chía', 90);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 12, 112, 'Sendero del Río Grande', 'Río', '2026-01-15', '08:30', 'Antioquia', 'Medellín', 130);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 13, 113, 'Ruta del Sol', 'Montaña', '2026-02-01', '06:30', 'Boyacá', 'Tunja', 180);

INSERT INTO CAMINATA_ENTITY (DTYPE, id, numero, titulo, tipo, fecha, hora, departamento, ciudad, duracion_estimada_minutos)
VALUES ('CaminataEntity', 14, 114, 'Exploración del Desierto', 'Desierto', '2026-02-10', '07:00', 'La Guajira', 'Riohacha', 240);
...
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (4, 15, 53, 3, 3, 3, '2024-09-16 09:32:22', 3, 'Heidie', 'Bekki', 'Halette', 'Marika');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (1, 69, 99, 4, 4, 4, '2024-06-27 01:25:54', 4, 'Fannie', 'Jeanine', 'Charis', 'Raffaello');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (4, 2, 94, 5, 5, 5, '2024-11-19 06:01:47', 5, 'Wendeline', 'Windy', 'Sada', 'Michaeline');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (6, 53, 31, 6, 6, 6, '2024-09-11 08:37:59', 6, 'Alyson', 'Suzanne', 'Dasha', 'Lorry');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (1, 37, 17, 7, 7, 7, '2024-08-08 15:31:53', 7, 'Marian', 'Redd', 'Austine', 'Ulrikaumeko');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (7, 67, 46, 8, 8, 8, '2024-04-15 17:52:18', 8, 'Niven', 'Karlotte', 'Lynna', 'Darby');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (4, 16, 10, 9, 9, 9, '2024-09-27 00:31:25', 9, 'Marieann', 'Washington', 'Lawton', 'Syman');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (2, 99, 84, 10, 10, 10, '2024-03-28 01:00:19', 10, 'Wylie', 'Jobie', 'Vinnie', 'Ophelia');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (6, 1, 91, 11, 11, 11, '2024-12-07 23:11:33', 11, 'Filberto', 'Jacquelyn', 'Almeta', 'Lennie');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (4, 99, 89, 12, 12, 12, '2024-12-27 14:21:52', 12, 'Helaine', 'Lyndell', 'Seumas', 'Samara');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (4, 43, 1, 13, 13, 13, '2024-04-09 02:16:45', 13, 'Odessa', 'Indira', 'Gabrielle', 'Leisha');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (2, 15, 52, 14, 14, 14, '2024-03-23 13:28:41', 14, 'Markus', 'Marleah', 'Arch', 'Lilllie');
insert into PAGO_ENTITY (CUOTAS, VALOR_CAMINATA, VALOR_TOTAL, CAMINATA_ID, CAMINANTE_ID, EMPRESA_ID, FECHA_VENCIMIENTO, ID, CCV, NUMERO_TARJETA, NUMERO_TRANSACCION, PROPIETARIO) values (3, 10, 40, 15, 15, 15, '2024-04-17 12:57:24', 15, 'Ramonda', 'Kelbee', 'La verne', 'Vladamir');

insert into SEGURO_ENTITY (id, numero, nombre, tipo, cobertura, condiciones, costo) values (1, 1, 'Proteccion Total', 'Accidentes Personales', 'Cobertura medica en caso de accidentes durante la caminata', 'Aplica solo para caminatas dentro del territorio nacional', 203000);
insert into SEGURO_ENTITY (id, numero, nombre, tipo, cobertura, condiciones, costo) values (2, 2, 'Seguro de Equipaje', 'Perdida de equipo', 'Reembolso por perdida o daño del equipo deportivo', 'Debe presentarse una denuncia en un maximo de 48 horas', 122000);
insert into SEGURO_ENTITY (id, numero, nombre, tipo, cobertura, condiciones, costo) values (3, 3, 'Cobertura Legal', 'Responsabilidad Civil', 'Cubre daños a terceros durante la caminata', 'Solo aplica en caminatas organizadas por Caminatas Colombia', 304000);
insert into SEGURO_ENTITY (id, numero, nombre, tipo, cobertura, condiciones, costo) values (4, 4, 'Proteccion Total', 'Accidentes Personales', 'Cobertura medica en caso de accidentes durante la caminata', 'Aplica solo para caminatas dentro del territorio nacional', 203000);
insert into SEGURO_ENTITY (id, numero, nombre, tipo, cobertura, condiciones, costo) values (5, 5, 'Seguro de Equipaje', 'Perdida de equipo', 'Reembolso por perdida o daño del equipo deportivo', 'Debe presentarse una denuncia en un maximo de 48 horas', 122000);
insert into SEGURO_ENTITY (id, numero, nombre, tipo, cobertura, condiciones, costo) values (6, 6, 'Cobertura Legal', 'Responsabilidad Civil', 'Cubre daños a terceros durante la caminata', 'Solo aplica en caminatas organizadas por Caminatas Colombia', 304000);
insert into SEGURO_ENTITY (id, numero, nombre, tipo, cobertura, condiciones, costo) values (7, 7, 'Proteccion Total', 'Accidentes Personales', 'Cobertura medica en caso de accidentes durante la caminata', 'Aplica solo para caminatas dentro del territorio nacional', 203000);
