...
class CaminanteServiceTest {
     ...
     */
    @Test
    void testCreateCaminante_ValidData_Success() throws IllegalOperationException {
        CaminanteEntity caminante = factory.manufacturePojo(CaminanteEntity.class);
    ...
    */
    ...
    @Test
    void testCreateCaminante_InvalidNombre_EmptyOrWrongFormat() {
        CaminanteEntity caminante = factory.manufacturePojo(CaminanteEntity.class);
    ...
    @Test
    void testCreateCaminante_InvalidDocumento_EmptyOrWrongFormat() {
        CaminanteEntity caminante = factory.manufacturePojo(CaminanteEntity.class);
        ...
        assertTrue(exception.getMessage().contains("El documento debe contener al menos 8 dígitos"));
    }

    @Test
    void testCreateCaminante_InvalidCorreo_EmptyOrWrongFormat() {
        CaminanteEntity caminante = factory.manufacturePojo(CaminanteEntity.class);
    ...
    @Test
    void testCreateCaminante_InvalidTelefono_EmptyOrWrongFormat() {
        CaminanteEntity caminante = factory.manufacturePojo(CaminanteEntity.class);
    ...
    @Test
    void testCreateCaminante_InvalidDireccion_Empty() {
        CaminanteEntity caminante = factory.manufacturePojo(CaminanteEntity.class);
     ...
     */
    @Test
    void testUpdateCaminante_ValidData_Success() throws EntityNotFoundException, IllegalOperationException {
    ...
    @Test
    void testUpdateCaminante_InvalidNombre() {
        CaminanteEntity entity = caminanteList.get(0);
        CaminanteEntity caminanteAct = factory.manufacturePojo(CaminanteEntity.class);
    ...
    @Test
    void testUpdateCaminante_InvalidDocumento() {
        CaminanteEntity entity = caminanteList.get(0);
        CaminanteEntity caminanteAct = factory.manufacturePojo(CaminanteEntity.class);
        // Prueba con documento vacío
    ...
    @Test
    void testUpdateCaminante_InvalidCorreo() {
        CaminanteEntity entity = caminanteList.get(0);
        CaminanteEntity caminanteAct = factory.manufacturePojo(CaminanteEntity.class);
        // Prueba con correo vacío
    ...
    @Test
    void testUpdateCaminante_InvalidTelefono() {
        CaminanteEntity entity = caminanteList.get(0);
        CaminanteEntity caminanteAct = factory.manufacturePojo(CaminanteEntity.class);
        // Prueba con teléfono vacío
    ...
    @Test
    void testUpdateCaminante_InvalidDireccion() {
        CaminanteEntity entity = caminanteList.get(0);
        CaminanteEntity caminanteAct = factory.manufacturePojo(CaminanteEntity.class);
        // Prueba con dirección vacía
